...
history = open("../../datasets/history-250K.json", "r")
jsonHistory = json.load(history)

resultados = []

for i in range(len(jsonHistory)):
    color_chars_map = {"white": "B", "black": "P", "red": "V"}
    resultados.append(color_chars_map[jsonHistory[i]["color"]])
